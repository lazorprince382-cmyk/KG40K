const CACHE="kasangati-v76";
const SHELL=[
  "/","/index.html","/styles.css?v=64","/brand-theme.css?v=63","/brand-no-green.css?v=4","/legal-member-exit.css?v=1","/app.js?v=71",
  "/app-core.js?v=72","/department-theme.js?v=63","/department-core.js?v=65",
  ...
  "/member-portal.js?v=68","/official-policy-ui.js?v=3","/loan-calculator.js?v=5",
