const CACHE="kasangati-v134";
const SHELL=[
  "/","/index.html","/styles.css?v=88","/brand-theme.css?v=64","/brand-no-green.css?v=16","/legal-member-exit.css?v=1","/app.js?v=118",
  "/app-core.js?v=114","/department-theme.js?v=63","/department-core.js?v=68",
  ...
  "/official-policy-ui.js?v=7","/member-portal.js?v=97","/loan-calculator.js?v=5",
