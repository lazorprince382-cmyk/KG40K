const CACHE="kasangati-v179";
const SHELL=[
  "/","/index.html","/styles.css?v=106","/brand-theme.css?v=64","/brand-no-green.css?v=17","/legal-member-exit.css?v=2","/app.js?v=164",
  "/app-core.js?v=152","/department-theme.js?v=63","/department-core.js?v=68",
