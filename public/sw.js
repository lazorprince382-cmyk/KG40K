const CACHE="kasangati-v125";
const SHELL=[
  "/","/index.html","/styles.css?v=86","/brand-theme.css?v=64","/brand-no-green.css?v=16","/legal-member-exit.css?v=1","/app.js?v=111",
  "/app-core.js?v=109","/department-theme.js?v=63","/department-core.js?v=66",
  ...
  "/official-policy-ui.js?v=7","/member-portal.js?v=92","/loan-calculator.js?v=5",
