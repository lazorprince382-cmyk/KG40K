const CACHE="kasangati-v121";
const SHELL=[
  "/","/index.html","/styles.css?v=81","/brand-theme.css?v=64","/brand-no-green.css?v=16","/legal-member-exit.css?v=1","/app.js?v=105",
  "/app-core.js?v=105","/department-theme.js?v=63","/department-core.js?v=65",
