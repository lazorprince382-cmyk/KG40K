const CACHE="kasangati-v159";
const SHELL=[
  "/","/index.html","/styles.css?v=99","/brand-theme.css?v=64","/brand-no-green.css?v=17","/legal-member-exit.css?v=2","/app.js?v=144",
  "/app-core.js?v=134","/department-theme.js?v=63","/department-core.js?v=68",
  ...
  "/official-policy-ui.js?v=11","/member-portal.js?v=105","/loan-calculator.js?v=7",
