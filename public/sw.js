const CACHE="kasangati-v158";
const SHELL=[
  "/","/index.html","/styles.css?v=99","/brand-theme.css?v=64","/brand-no-green.css?v=17","/legal-member-exit.css?v=1","/app.js?v=143",
  "/app-core.js?v=133","/department-theme.js?v=63","/department-core.js?v=68",
  "/audit-dashboard.js?v=63","/audit-modules.js?v=63","/welfare-module.js?v=64",
  ...
  "/official-policy-ui.js?v=11","/member-portal.js?v=104","/loan-calculator.js?v=7",
