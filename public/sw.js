...
const SHELL=[
  "/","/index.html","/styles.css?v=85","/brand-theme.css?v=64","/brand-no-green.css?v=16","/legal-member-exit.css?v=1","/app.js?v=110",
  ...
  "/official-policy-ui.js?v=7","/member-portal.js?v=91","/loan-calculator.js?v=5",
