const CACHE="kasangati-v133";
const SHELL=[
  "/","/index.html","/styles.css?v=88","/brand-theme.css?v=64","/brand-no-green.css?v=16","/legal-member-exit.css?v=1","/app.js?v=117",
  "/app-core.js?v=113","/department-theme.js?v=63","/department-core.js?v=68",
