const CACHE="kasangati-v132";
const SHELL=[
  "/","/index.html","/styles.css?v=87","/brand-theme.css?v=64","/brand-no-green.css?v=16","/legal-member-exit.css?v=1","/app.js?v=116",
  ...
  "/official-policy-ui.js?v=7","/member-portal.js?v=96","/loan-calculator.js?v=5",
