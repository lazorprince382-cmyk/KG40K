const CACHE="kasangati-v197";
const SHELL=[
  "/","/index.html","/styles.css?v=110","/brand-theme.css?v=64","/brand-no-green.css?v=17","/legal-member-exit.css?v=2","/app.js?v=182",
  "/app-core.js?v=170","/department-theme.js?v=63","/department-core.js?v=68",
  "/audit-dashboard.js?v=63","/audit-modules.js?v=63","/welfare-module.js?v=72",
  "/legal-module.js?v=65","/legal-biodata-module.js?v=69","/legal-family-ui.js?v=2","/legal-member-exit-ui.js?v=2",
  "/legal-registration-module.js?v=63","/supervisory-module.js?v=63","/department-events.js?v=63",
  "/official-policy-ui.js?v=11","/member-portal.js?v=113","/loan-calculator.js?v=7",
